def content_service_summary_lambda_function(env):
...
def main():
    ...
    parameter = ssm.get_parameter(
        Name=f'/cft/ses/{env}-alfresco-alfresco_password', WithDecryption=True)
    username = "admin"
    password = (parameter['Parameter']['Value'])

    url1 = f'https://alfresco-ses-{env}-internal.srrcsbs.org/alfresco/s/enterprise/admin/admin-systemsummary'
    method1 = 'GET'
    postData1 = ""
    headers1 = {{
