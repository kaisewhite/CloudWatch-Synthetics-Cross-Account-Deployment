def content_service_ready_lambda_function(env):
...
def main():
    ...
    url1 = 'https://alfresco-ses-{env}-internal.srrcsbs.org/alfresco/api/-default-/public/alfresco/versions/1/probes/-ready-'
    method1 = 'GET'
    postData1 = ""
    headers1 = {{}}
